  ...
  <div class="user-profile" v-loading="loading">
    <div class="container" v-if="user">
      <div class="header">
        ...
        <div class="actions" v-if="authStore.isAuthenticated && authStore.user.id !== user.id">
          <el-button type="primary" @click="toggleFollow" :loading="following">
...
<style scoped>
.user-profile { padding: 24px 0; background: var(--el-bg-color-page); min-height: 100vh; }
.container { max-width: 1100px; margin: 0 auto; padding: 0 20px; }
.header { background: #fff; border: 1px solid var(--el-border-color-lighter); border-radius: 8px; padding: 16px; display: flex; gap: 16px; align-items: center; }
.meta h2 { margin: 0 0 4px 0; }
.meta p { margin: 0; color: var(--el-text-color-secondary); }
.stats { display: flex; gap: 12px; font-size: 13px; color: var(--el-text-color-secondary); margin-top: 6px; }
