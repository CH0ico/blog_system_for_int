...
.card { background: #fff; border: 1px solid var(--el-border-color-lighter); border-radius: 8px; padding: 16px; }
.avatar-uploader { display: inline-block; }
.avatar { width: 120px; height: 120px; border-radius: 50%; display: block; }
.avatar-uploader-icon { font-size: 28px; color: var(--el-text-color-secondary); width: 120px; height: 120px; border: 1px dashed var(--el-border-color); display: inline-flex; align-items: center; justify-content: center; border-radius: 50%; }
.help { margin: 4px 0 0; color: var(--el-text-color-secondary); font-size: 12px; }
.posts { display: flex; flex-direction: column; gap: 10px; margin-top: 8px; }
</style>
